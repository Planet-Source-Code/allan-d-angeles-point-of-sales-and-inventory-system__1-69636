...
Begin VB.Form frmrts_report 
   ...
   Begin VB.PictureBox picinfo 
      ...
      Begin VB.PictureBox picdaily 
         ...
         Begin VB.ComboBox cbomm 
            ...
            EndProperty
            Height          =   420
            ItemData        =   "frmrts_report.frx":0000
            Left            =   1200
            List            =   "frmrts_report.frx":0028
            TabIndex        =   9
            Text            =   "mm"
            Top             =   360
            Width           =   1695
         ...
         Begin VB.ComboBox cbodd 
            ...
            EndProperty
            Height          =   420
            ItemData        =   "frmrts_report.frx":005C
            Left            =   2880
            List            =   "frmrts_report.frx":00BD
            TabIndex        =   8
            Text            =   "dd"
            Top             =   360
            Width           =   1695
      ...
      Begin VB.PictureBox picmonthly 
         ...
         Begin VB.ComboBox mm 
            ...
            EndProperty
            Height          =   420
            ItemData        =   "frmrts_report.frx":013D
            Left            =   1200
            List            =   "frmrts_report.frx":0165
            TabIndex        =   2
            Text            =   "mm"
            Top             =   360
            Width           =   1695
   ...
   End
End
Attribute VB_Name = "frmrts_report"
...
rst.Open "Select * from tblrts where mm='" & cbomm & "' and dd='" & cbodd & "' and yyyy='" & txtyyyy & "'", con, adOpenDynamic, adLockOptimistic
While rst.EOF = False

Set dtprfc_report.DataSource = rst
dtprfc_report.Sections("Section2").Controls.Item("lbldaily").Caption = "Daily"
dtprfc_report.Sections("Section2").Controls.Item("lbloption").Caption = "Return to supplier report"
...
Wend
Else
rst.Open "Select * from tblrts where mm='" & mm & "' and yyyy='" & yyyy & "'", con, adOpenDynamic, adLockOptimistic
While rst.EOF = False
