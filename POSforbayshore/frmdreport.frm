   ...
   Begin VB.PictureBox picinfo 
      ...
      Begin VB.PictureBox picdaily 
         ...
         Begin VB.ComboBox cbomm 
            ...
            EndProperty
            Height          =   420
            ItemData        =   "frmdreport.frx":0000
            Left            =   1200
            List            =   "frmdreport.frx":0028
            TabIndex        =   10
            Text            =   "mm"
            Top             =   360
            Width           =   1695
         ...
         Begin VB.ComboBox cbodd 
            ...
            EndProperty
            Height          =   420
            ItemData        =   "frmdreport.frx":005C
            Left            =   2880
            List            =   "frmdreport.frx":00BD
            TabIndex        =   9
            Text            =   "dd"
            Top             =   360
            Width           =   1695
      ...
      Begin VB.PictureBox picmonthly 
         ...
         Begin VB.ComboBox mm 
            ...
            EndProperty
            Height          =   420
            ItemData        =   "frmdreport.frx":013D
            Left            =   1200
            List            =   "frmdreport.frx":0165
            TabIndex        =   4
            Text            =   "mm"
            Top             =   360
            Width           =   1695
...
lst.ListItems(lst.ListItems.Count).ListSubItems.Add , , rst!pending
...
rst.Open "Select * from tbldelivery where mm='" & cbomm & "' and dd='" & cbodd & "' and yyyy='" & txtyyyy & "'", con, adOpenDynamic, adLockOptimistic
While rst.EOF = False

Set dtpdreport.DataSource = rst
dtpdreport.Sections("Section2").Controls.Item("lbldaily").Caption = "Daily"
dtpdreport.Sections("Section5").Controls.Item("lbluser").Caption = mdimain.lblname
dtpdreport.Sections("Section5").Controls.Item("lbldate").Caption = Date
dtpdreport.Sections("Section5").Controls.Item("lbltot").Caption = txttot
dtpdreport.Show
cmdprint.Enabled = False
rst.MoveNext
Wend
Else
rst.Open "Select * from tbldelivery where mm='" & mm & "' and yyyy='" & yyyy & "'", con, adOpenDynamic, adLockOptimistic
While rst.EOF = False

Set dtpdreport.DataSource = rst
dtpdreport.Sections("Section2").Controls.Item("lbldaily").Caption = "Monthly"
dtpdreport.Sections("Section5").Controls.Item("lbluser").Caption = mdimain.lblname
dtpdreport.Sections("Section5").Controls.Item("lbldate").Caption = Date
dtpdreport.Sections("Section5").Controls.Item("lbltot").Caption = txttot
dtpdreport.Show
